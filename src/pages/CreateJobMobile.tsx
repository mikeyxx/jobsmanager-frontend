      ...
      <div className="h-full w-full my-8 px-4">
        <section className="bg-white w-full p-4 shadow-lg relative">
          ...
          <p
            className={
              errorMsg !== ""
                ? `bg-red-300 font-semibold rounded h-14 p-2 flex items-center justify-center absolute max-w-[50rem] top-16 createErrorMsg`
                : ""
            }
          >
            {errorMsg}
          ...
          <p
            className={
              successMsg !== ""
                ? `bg-green-300 font-semibold rounded h-14 p-2 flex items-center justify-center absolute max-w-[50rem] top-16 createErrorMsg`
                : ""
            }
          >
            {successMsg}
...
export default CreateJobMobile;
