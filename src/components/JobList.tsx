...
const JobList = ({ job, fetchSingleJob }: Props) => {
  ...
  return (
    <section>
      <article
        className="rounded-lg p-4 mb-4 cursor-pointer outline outline-1"
        onClick={() => fetchSingleJob(job)}
      >
        <h3 className="font-bold hover:underline">{job.job_title}</h3>
